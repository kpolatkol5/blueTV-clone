...
def filmler(request):
    def categori_in_filmler(kategori):
        """
             Bu fonksiyon çoka çok ilişkili olan kategorilerin geriye dönük sorgularında filmleri kategorilere göre almak için 
             kullanıyorum. Tek tek get() metodu kullanmak istemedim. Katagorileri tek tek alır , kategori adı ve  kategoriye 
             ait olan filmleri bir listeye atar.
        """
        result=[]
        for i in kategori:
